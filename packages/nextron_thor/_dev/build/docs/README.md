...
2. Search for **Nextron Thor APT Scanner** and add the integration.
...
2. Confirm events from your completed scan appear within the configured polling interval.
3. If no data appears, check the following:

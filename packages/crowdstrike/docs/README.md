...
1. **CrowdStrike Event Streams API**:
...
You can collect CrowdStrike Falcon data through different methods depending on your environment and available APIs.

### Collect data via CrowdStrike Falcon SIEM Connector

To collect data using the Falcon SIEM Connector, You need file path where the connector stores event data received from the Event Streams.
...
### Collect data via CrowdStrike Event Stream
